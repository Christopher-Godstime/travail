...
import RingRing from "../../audio/otnickawhereareyou128kringtone-58414.mp3";
    ...
    <div className="call_modal z-40">
      ...
      >
        <div className="text-center" style={{ padding: "40px 0" }}>
          ...
          <h4 className="text-[20px]">{call.username}</h4>
          <h6 className="text-[15px] font-light">{call.job}</h6>
          ...
          {answer ? (
            ...
            <div className="text-[12px] my-[5px] font-light">
              {call.video ? (
